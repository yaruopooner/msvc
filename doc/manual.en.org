...
# last updated : 2015/07/21.22:07:27
...
** Coexistence of different version of the Visual Studio and uses
...
** Jump and return for include file
...
** Launch the Visual Studio from project or solution
...
* Instrallation
** launch configuration for Emacs
...
** package configuration for Emacs
   以下のパッケージの設定が必要です。
...
* How to use
** Parses and Registrations for Project 1
...
** Parses and Registrations for Project 2
   ~/.emacs.d/
   に
   .msvc
...
** Jump to error file from build log of project or solution
...
** Reparse for project and solution
   利用可能な場所：どこでも
